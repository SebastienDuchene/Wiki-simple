...
<div id="edit-page" class="content scaffold-create" role="main">
    <h1><g:message code="default.editPage" default="Edit Page"/></h1>
    ...
    <g:form action="saveEdit" method="POST">
        <g:hiddenField name="id" value="${page?.id}"></g:hiddenField>
        <fieldset class="form">
            <input name="title" placeholder="Title" required="" value="${page?.title}" id="title" type="text">
            <g:textArea  name="content" placeholder ="Content" value="${page?.content}" required="" rows="15" cols="100"/>
        </fieldset>
        <fieldset class="buttons">
            <g:submitButton name="savePage" placeholder="Content" action="saveEdit" value="Edit Page" ></g:submitButton>
        </fieldset>
    </g:form>
